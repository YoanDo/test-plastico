...
const VideoHeader = () => {
  ...
  const videoEN = "https://plasticostorageprod.blob.core.windows.net/public/header_video_en.mp4"
  const videoFR = "https://plasticostorageprod.blob.core.windows.net/public/header_video_fr.mp4"
